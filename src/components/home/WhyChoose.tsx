...
const WHY_CHOOSE_BG =
  "https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?auto=format&fit=crop&w=2400&q=100";
...
/** Dark navy overlay (reference-style) so header + cards read clearly; subtle lime at bottom for brand. */
